...
internal static class SNet_LobbyManager__OnJoinedLobby__Patch
{
...
internal static class SNet_SyncManager__OnFoundMaster__Patch
{
    public static readonly string PatchGroup = PatchGroups.REQUIRED;
...
internal static class SNet_SessionHub__AddPlayerToSession__Patch
{
    public static readonly string PatchGroup = PatchGroups.REQUIRED;
